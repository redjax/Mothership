...
<table align="center">
  ...
  <tr align="center">
    <td><!--LAST_UPDATED-->2026-04-26 06:11 UTC<!--END_LAST_UPDATED--></td>
  </tr>
</table>
...
| ----------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Ansible           | [https://github.com/redjax/Ansible](https://github.com/redjax/Ansible.git)                     | My Ansible monorepo, with collections, roles, & playbooks for managing my homelab.                                                                                                                                                                                 |
| cheatsheets       | [https://github.com/redjax/cheatsheets](https://github.com/redjax/cheatsheets.git)             | My personal manpages. Includes a Go CLI for reading and managing cheatsheets.                                                                                                                                                                                      |
| Dockerfiles       | [https://github.com/redjax/Dockerfiles](https://github.com/redjax/Dockerfiles)                 | My custom Dockerfiles, with scripts & CI/CD pipelines to automate syncing containers with upstream patches & publishing to the Github Container Registry.                                                                                                          |
| docker_templates  | [https://github.com/redjax/docker_templates](https://github.com/redjax/docker_templates)       | A large repository containing many Docker/Docker Compose containers for services I've self-hosted.                                                                                                                                                                 |
| dotfiles          | [https://github.com/redjax/dotfiles](https://github.com/redjax/dotfiles.git)                   | My Linux dotfiles, managed with Chezmoi.                                                                                                                                                                                                                           |
| emacs             | [https://github.com/redjax/emacs](https://github.com/redjax/emacs.git)                         | My Emacs configuration.                                                                                                                                                                                                                                            |
| git_dir           | [https://github.com/redjax/git_dir](https://github.com/redjax/git_dir.git)                     | My `~/git` directory as a repository.                                                                                                                                                                                                                              |
| helix             | [https://github.com/redjax/helix](https://github.com/redjax/helix.git)                         | My Helix editor configuration.                                                                                                                                                                                                                                     |
| neovim            | [https://github.com/redjax/neovim](https://github.com/redjax/neovim.git)                       | A repository containing my neovim configuration(s), plus management scripts & cross-platform support.                                                                                                                                                              |
| Notetkr           | [https://github.com/redjax/Notetkr](https://github.com/redjax/Notetkr.git)                     | Go app for taking notes/journal entries in the terminal.                                                                                                                                                                                                           |
| PipelineTemplates | [https://github.com/redjax/PipelineTemplates](https://github.com/redjax/PipelineTemplates.git) | CI/CD pipeline files for Github Actions/Workflows, Gitlab, Concourse, & more. Pipelines in this repository can be called via pipeline stubs in other repositories.                                                                                                 |
| PowershellModules | [https://github.com/redjax/PowershellModules](https://github.com/redjax/PowershellModules.git) | Powershell modules I've written for work or personal use. I don't generally publish them, I just copy/paste or download them to my $PATH.                                                                                                                          |
| PowershellProfile | [https://github.com/redjax/PowershellProfile](https://github.com/redjax/PowershellProfile.git) | My Powershell profile with custom modules & functions.                                                                                                                                                                                                             |
| syst              | [https://github.com/redjax/syst](https://github.com/redjax/syst.git)                           | A "swiss army knife" CLI utility written in Go.                                                                                                                                                                                                                    |
| system_scripts    | [https://github.com/redjax/Mothership](https://github.com/redjax/Mothership.git)               | A repository I've been adding to for many years (despite what the commit history shows), contains many scripts I've created or straight up copied (where legal, thank you to everyone who figured things out before me!) for multiple versions of Linux & Windows. |
| templates         | [https://github.com/redjax/templates](https://github.com/redjax/templates.git)                 | My templates monorepo, where I store copy/paste-able versions of pipelines & other code.                                                                                                                                                                           |
| Terraform         | [https://github.com/redjax/Terraform](https://github.com/redjax/Terraform.git)                 | My Terraform monorepo, where I store Terraform modules I write for myself.                                                                                                                                                                                         |
| Toolbelt          | [https://github.com/redjax/Toolbelt](https://github.com/redjax/Toolbelt.git)                   | Dynamic `README.md` file populated by a JSON file & Python script. An awesomelist-style collection of tools I use.                                                                                                                                                 |
| wezterm           | [https://github.com/redjax/wezterm](https://github.com/redjax/wezterm.git)                     | My Wezterm configuration.                                                                                                                                                                                                                                          |
