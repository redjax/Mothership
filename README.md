...
| PipelineTemplates | https://github.com/redjax/PipelineTemplates | CI/CD pipeline files for Github Actions/Workflows, Gitlab, Concourse, & more. Pipelines in this repository can be called via pipeline stubs in other repositories.                                                                                                 |
